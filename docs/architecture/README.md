...
| [0007](adr/0007-http-api-contract-and-offline-sync.md)        | REST with OpenAPI 3.1 generated from zod, served by Hono; `/v1` path versioning; answers queued offline and replayed idempotently.         | Accepted                                                           |
| [0008](adr/0008-web-client-as-static-spa.md)                  | Replace Next.js with a Vite + React SPA on S3 and CloudFront, keeping the design lock and components.                                      | Accepted                                                           |
| [0009](adr/0009-aws-topology-environments-and-operations.md)  | CloudFront → API Gateway HTTP API → Lambda, no VPC; infrastructure as code; "portfolio grade" operations.                                  | Accepted; account split and IaC tool Proposed                      |
