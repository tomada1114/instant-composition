...
| [0008](adr/0008-web-client-as-static-spa.md)                  | Replace Next.js with a Vite + React SPA on S3 and CloudFront, keeping the design lock and components.                                      | Accepted; port libraries amended, types-only client Proposed       |
