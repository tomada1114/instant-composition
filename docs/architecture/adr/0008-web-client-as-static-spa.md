...
- Status: Accepted (2026-09-23). Amended 2026-09-23 when the port started (issue #42):
  Accepted — TanStack Router, TanStack Query, use-intl, and types generated by
  @hey-api/openapi-ts with the calls written by hand (see
  [Amendment](#amendment-2026-09-23-the-ports-libraries))
- Date: 2026-09-23
- Deciders: the owner
