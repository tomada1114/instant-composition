...
export function makeSummary(overrides: Partial<RoundSummary> = {}): RoundSummary {
  return {
    ...
    growth: {
      ...
      firstTime: 4,
      rows: [
        { cardId: "c1", ja: "会議を来週に延ばせますか", kind: "faster", deltaMs: 1200 },
        {
          cardId: "c2",
          ja: "見積もりを明日まで待ってください",
          kind: "fixed",
        ...
        { cardId: "c4", ja: "資料を先に送ります", kind: "faster", deltaMs: 500 },
        { cardId: "c5", ja: "打ち合わせは三時からです", kind: "fixed", deltaMs: 100 },
      ],
    },
    review: [
      { cardId: "r1", ja: "請求書は今日中に送ります" },
      { cardId: "r2", ja: "在庫を確認してから連絡します" },
      { cardId: "r3", ja: "会議室を予約しておきます" },
      { cardId: "r4", ja: "取引先に折り返し電話します" },
    ],
