...
const MESSAGE_KEYS = [
  ...
  "Home.today.title",
  "Home.today.size",
  "Home.today.sizeShort",
  "Home.today.shortage",
  "Home.today.mix",
  "Home.today.mixFocus",
  "Home.today.start",
  "Home.progress.today",
  "Home.progress.yesterday",
  "Home.progress.count",
  "Home.progress.resume",
  "Home.done.title",
  "Home.done.count",
  "Home.done.recap",
  "Home.done.more",
  ...
  "Home.recover.size",
  "Home.recover.start",
  "Home.recover.restart",
  "Home.deadline",
  "Home.notEnough.title",
  "Home.notEnough.body",
  "Home.notEnough.widen",
  "Home.loadFailed.title",
  ...
  "Drill.card.pause",
  "Drill.card.progress",
  "Drill.card.retryProgress",
  "Drill.card.comboLabel",
  "Drill.card.again",
  "Drill.card.flip",
  "Drill.card.point",
  "Drill.card.seconds",
  ...
  "Drill.card.next",
  "Drill.card.fast",
  "Drill.announce.front",
  "Drill.announce.timeout",
  "Drill.announce.said",
  "Drill.announce.review",
  "Drill.sheet.title",
  "Drill.sheet.hint",
  "Drill.sheet.quit",
  ...
  "Drill.save.resend",
  "Summary.title.today",
  "Summary.title.yesterday",
  "Summary.title.recap",
  "Summary.close",
  "Summary.back",
  "Summary.growth.title",
  "Summary.growth.faster",
  "Summary.growth.fixed",
  "Summary.growth.delta",
  "Summary.growth.fixedRow",
  "Summary.growth.compared",
  "Summary.growth.again",
  "Summary.growth.firstTime",
  "Summary.growth.firstNext",
  ...
  "Summary.collapse",
  "Summary.streakUnit",
  "Summary.restartTitle",
  "Summary.difficulty.line",
  "Summary.difficulty.up",
  "Summary.difficulty.down",
  "Summary.placement.title",
  "Summary.placement.start",
  "Summary.placement.note",
  "Summary.reach.title",
  "Summary.reach.next",
  ...
  "Records.totals",
  "Records.points",
  "Records.titles.title",
  "Records.titles.streak",
  "Records.titles.none",
  "Records.rules.mastered",
  "Records.rules.streak",
  "Settings.title",
  "Settings.back",
  "Settings.topics.title",
  "Settings.topics.keepOne",
  "Settings.focus.title",
  "Settings.focus.note",
  "Settings.focus.limit",
  "Settings.focus.removed",
  "Settings.size.title",
  "Settings.size.count",
  "Settings.size.note",
  "Settings.size.completed",
  ...
  "Settings.retest.title",
  "Settings.retest.body",
  "Settings.retest.cancel",
  "Settings.retest.confirm",
  "Settings.saveFailed",
  "Drill.error.notEnoughTitle",
  "Drill.error.notEnough",
  "Drill.error.widen",
  "Drill.error.loadTitle",
  "Drill.error.reload",
