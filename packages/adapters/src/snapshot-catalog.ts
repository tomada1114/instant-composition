...
const UNREADABLE: Read = err({ code: "ERR_CONTENT_UNREADABLE", reason: "unreadable" });
 ...
 * throw, with a `reason` telling them apart, and is not remembered: the next call reads again, so a snapshot
